...
// 			}
      ...
      if ($id_good && $checked) {
  			...
  			value=\"$id\" title=\"Upřednostní produkt v této kategorii a v nadřazených kategoriích\" $checkedu $readonlyu/><span title=\"Upřednostní produkt v této kategorii a v nadřazených kategoriích\"><b> Upřednostnit v kategoriích</b></span><br/>";
      }
      else {
