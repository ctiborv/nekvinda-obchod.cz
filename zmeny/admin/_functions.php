...
// 			}
      ...
      if ($id_good && $checked) {
  			...
  			$checkbox .= "<a onclick=\"s('m$id'); return false;\">  $name </a><br/>$indent&nbsp;&nbsp;<input type=\"checkbox\" name=\"id_upr[]\" 
  			value=\"$id\" title=\"$title_atru\" $checkedu $readonlyu/><b> Upřednostnit v této kategorii</b><br/>";
      }
      else {
      //checkbox bez upřednostnění
			$checkbox .= "$indent<input type=\"checkbox\" name=\"id_parent[]\" 
			value=\"$id\" title=\"$title_atr\" $checked $readonly/><a onclick=\"s('m$id'); return false;\">  $name </a><br/>";
      }
